...
if __name__ == '__main__':
    ...
    scenarios = [
        {'organ': 'bm', 'prep': 'scanpy',   'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'bm', 'prep': 'scetm',    'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'bm', 'prep': 'dca',      'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'brain', 'prep': 'scanpy',   'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'brain', 'prep': 'scetm',    'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'brain', 'prep': 'dca',      'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'pancreas', 'prep': 'scanpy',   'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'pancreas', 'prep': 'scetm',    'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
        {'organ': 'pancreas', 'prep': 'dca',      'seed': 37, 'thisK': 10, 'oversample': 300, 'ndim': 11},
    ]
